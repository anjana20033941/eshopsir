        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    ...
                    <p>
                        Here we are the eShop.lk&trade; to suppert you for
                        accomplish your dessire by selling hight quality product.
                    </p>
                </div>
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                ...
                <h5 class="text-uppercase text-warning mb-4">Contatcs</h5>
